...
3. **Support progressive difficulty** — start with the 10 guild names, unlock shards and wedges, then a mixed deck.
...
5. Which combos have the longest dwell times? (hardest names)
...
- **Tier unlock**: Complete a session → next tier becomes available
...
- **Full session**: Start a Guilds session, tap through cards, timer runs out, see summary
- **Tier progression**: Complete Guilds → unlock Shards & Wedges → complete → unlock All Core
- **Persistence**: Unlock a tier, refresh the page, tier remains unlocked (localStorage)

...
Llewellyn had 3 pieces of advice: show them the names, get clever about the random name selection, and add audio.

I want to get at least the first one done before handing out stickers.

### Show them the names

- before the level starts, show them all 5 names. This is the "intro slide"
  - I tried implementing a whole intro screen but it was too complicated, it couldn't get the animation.
- keep showing them all five names, with an opportunity to shrink that.
